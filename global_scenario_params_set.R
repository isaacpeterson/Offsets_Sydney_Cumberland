...
initialise_user_global_params <- function(folder_to_use){
  ...
  global_params$feature_raster_files = paste0(simulation_base_folder, 'prepared_data_feb_23/', 
                                              list.files(path = paste0(simulation_base_folder, 'prepared_data_feb_23/'),
                                                          pattern = 'PCT_849_feature_', all.files = FALSE, 
                                                          full.names = FALSE, recursive = FALSE, ignore.case = FALSE, 
                                                          include.dirs = FALSE, no.. = FALSE))
  
  global_params$condition_class_raster_files = paste0(simulation_base_folder, 'prepared_data_feb_23/', 
                                                      list.files(path = paste0(simulation_base_folder, 'prepared_data_feb_23/'),
                                                                  pattern = 'PCT_849_condition_class_', all.files = FALSE, 
                                                                  full.names = FALSE, recursive = FALSE, ignore.case = FALSE, 
                                                                  include.dirs = FALSE, no.. = FALSE))
  
  global_params$simulation_inputs_folder = paste0(simulation_base_folder, 'prepared_data_feb_23/')
...
initialise_user_simulation_params_global <- function(){ 
...
initialise_user_feature_params_global <- function(){
...
initialise_feature_dynamics_set <- function(feature_params, current_author_splines, management_index_to_use){ 
  ...
  management_dynamics_set = collate_dynamics(full_dynamics_set, management_datasheets, management_index_to_use)
